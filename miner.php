...
$mobilepage = [
 'DATE'    => null,
 'RIGS'    => null,
 'SUMMARY' => ['Elapsed', 'MHS av', 'MHS 5m', 'Found Blocks=Blks',
            'Difficulty Accepted=DiffA',
            'Difficulty Rejected=DiffR',
            'Hardware Errors=HW',
            'Work Utility=WU', ],
 'DEVS+NOTIFY' => ['DEVS.Name=Name', 'DEVS.ID=ID', 'DEVS.Status=Status',
 ...
 'POOL' => ['POOL', 'Status', 'Difficulty Accepted=DiffA',
            'Difficulty Rejected=DiffR', 'Last Share Time=LST', ], ];
$mobilesum = [
 'SUMMARY' => ['MHS av', 'MHS 5m', 'Found Blocks', 'Difficulty Accepted',
            'Difficulty Rejected', 'Hardware Errors',
            'Work Utility', ],
 'DEVS+NOTIFY' => ['DEVS.MHS av', 'DEVS.Difficulty Accepted',
            'DEVS.Difficulty Rejected', ],
 'POOL' => ['Difficulty Accepted', 'Difficulty Rejected'], ];
//
$statspage = [
 'DATE'    => null,
 'RIGS'    => null,
...
//
$statssum = [
 'SUMMARY' => ['MHS av', 'MHS 5m', 'Found Blocks',
...
$poolspage = [
 ...
 'POOL+STATS' => ['STATS.ID=ID', 'POOL.URL=URL',
...
$poolsext = [
 'POOL+STATS' => [
    'where' => null,
    'group' => ['POOL.URL', 'POOL.Has Stratum',
                'POOL.Stratum Active', 'POOL.Has GBT', ],
    'calc' => ['POOL.Difficulty Accepted' => 'sum',
            ...
            'POOL.Accepted'               => 'sum', ],
    'gen' => ['AvShr'                     => 'round(POOL.Difficulty Accepted/'.
...
$devnotpage = [
 'DATE'        => null,
 'RIGS'        => null,
 'DEVS+NOTIFY' => ['DEVS.Name=Name', 'DEVS.ID=ID',
            'DEVS.Temperature=Temp', 'DEVS.MHS av=MHS av',
...
$devdetpage = [
 'DATE'            => null,
 'RIGS'            => null,
 'DEVS+DEVDETAILS' => ['DEVS.Name=Name', 'DEVS.ID=ID',
...
$devdetsum = [
 'DEVS+DEVDETAILS' => ['DEVS.MHS av', 'DEVS.Difficulty Accepted',
                'DEVS.Difficulty Rejected', ], ];
//
$protopage = [
 'DATE'   => null,
 'RIGS'   => null,
 'CONFIG' => ['ASC Count=ASCs', 'PGA Count=PGAs', 'Pool Count=Pools',
 ...
 'POOL+STATS' => ['STATS.ID=ID', 'POOL.URL=URL', 'POOL.Accepted=Acc',
            'POOL.Difficulty Accepted=DiffA',
...
$protosum = [
 'SUMMARY' => ['MHS av', 'Found Blocks', 'Difficulty Accepted',
            'Difficulty Rejected', 'Hardware Errors',
            'Utility', 'Work Utility', ],
 'POOL+STATS' => ['POOL.Accepted', 'POOL.Difficulty Accepted',
...
$protoext = [
 'POOL+STATS' => [
    'where' => null,
    'group' => ['POOL.URL', 'POOL.Has GBT'],
    'calc'  => ['POOL.Accepted'        => 'sum',
...
$kanogenpage = [
 'DATE'         => null,
 'RIGS'         => null,
 'SUMMARY+COIN' => ['SUMMARY.Elapsed=Elapsed',
 ...
 'POOL' => ['URL', 'Diff1 Shares=Diff Work',
            'Difficulty Accepted=DiffA',
            'Difficulty Rejected=DiffR',
...
$kanogensum = [
 'SUMMARY+COIN' => ['GEN.Mined', 'GEN.GHS Acc', 'GEN.GHS av',
 ...
 'POOL' => ['Diff1 Shares', 'Difficulty Accepted',
...
$kanogenext = [
 'SUMMARY+COIN' => [
  'gen' => ['GHS Acc' => 'round(pow(2,32) * SUMMARY.Difficulty Accepted / '.
                'SUMMARY.Elapsed / 10000000) / 100',
        'Mined' => 'SUMMARY.Elapsed * SUMMARY.Work Utility / 60 / '.
                'COIN.Network Difficulty',
        'GHS av' => 'SUMMARY.MHS av / 1000.0',
        'GHS 5m' => 'SUMMARY.MHS 5m / 1000.0',
        'GHS WU' => 'round(pow(2,32) * SUMMARY.Work Utility / 60 / '.
                '10000000 ) / 100', ], ],
 'POOL' => [
  'group' => ['URL'],
  'calc'  => ['Diff1 Shares'      => 'sum', 'Difficulty Accepted' => 'sum',
            'Difficulty Rejected' => 'sum',
            'Difficulty Stale'    => 'sum', 'Best Share' => 'max', ],
  'gen' => ['Rej'                 => 'Difficulty Rejected / '.
...
$syspage = [
 ...
 'SUMMARY' => ['#', 'Elapsed', 'MHS av', 'MHS 5m', 'Found Blocks=Blks',
            ...
            'Last getwork', ],
 'DEVS' => ['#', 'ID', 'Name', 'ASC', 'Device Elapsed', 'Enabled',
            ...
            'Device Rejected%=Dev Rej%', ],
 'POOL' => ['POOL', 'URL', 'Status', 'Priority', 'Quota',
...
$syssum = [
 ...
 'DEVS' => ['MHS av', 'MHS 5s', 'MHS 5m', 'Diff1 Work',
            'Difficulty Accepted', 'Difficulty Rejected',
            'Hardware Errors', 'Total MH', ],
 'POOL' => ['Getworks', 'Diff1 Shares', 'Difficulty Accepted',
            'Difficulty Rejected', 'Difficulty Stale', ],
];
//
...
global $sys_pages;
$sys_pages = [
 'Mobile'  => [$mobilepage, $mobilesum],
 'Stats'   => [$statspage, $statssum],
 'Pools'   => [$poolspage, $poolssum, $poolsext],
 'DevNot'  => [$devnotpage, $devnotsum],
 'DevDet'  => [$devdetpage, $devdetsum],
 'Proto'   => [$protopage, $protosum, $protoext],
 'Kano'    => [$kanogenpage, $kanogensum, $kanogenext],
 'Summary' => [$syspage, $syssum],
];
//
// Don't touch these 2
$miner = null;
...
function fmt($section, $name, $value, $when, $alldata, $cf = null)
{
    ...
    if ($value === null) {
        $ret = $b;
        $done = true;
    } elseif ($cf != null and function_exists($cf)) {
...
global $singlerigsum;
$singlerigsum = [
 'devs' => ['MHS av'              => 1, 'MHS 5s' => 1, 'MHS 1m' => 1, 'MHS 5m' => 1,
